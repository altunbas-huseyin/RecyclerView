 ...
 */
public class GridLayoutManagerFragment extends Fragment {
     ...
     */
    public static GridLayoutManagerFragment newInstance() {
        GridLayoutManagerFragment gridLayoutManagerFragment = new GridLayoutManagerFragment();
        return gridLayoutManagerFragment;
    }

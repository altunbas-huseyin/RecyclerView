 ...
 */
public class StaggeredGridLayoutManagerFragment extends Fragment {

    public StaggeredGridLayoutManagerFragment() {
    }
    ...
    public static StaggeredGridLayoutManagerFragment newInstance() {
        StaggeredGridLayoutManagerFragment staggeredGridLayoutManagerFragment = new StaggeredGridLayoutManagerFragment();
        return staggeredGridLayoutManagerFragment;
    }
